...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Belajar CI4</span>
        </a>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= base_url('Mahasiswa') ?>"
                                   class="nav-link <?= $submenu == 'mahasiswa' ? 'active' : '' ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('Dosen') ?>"
                                   class="nav-link <?= $submenu == 'dosen' ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Dosen</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('Fakultas') ?>"
                                   class="nav-link <?= $submenu == 'fakultas' ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Fakultas</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('Prodi') ?>"
                                   class="nav-link <?= $submenu == 'prodi' ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Program Studi</p>
                                </a>
                            </li>
