...
class App extends BaseConfig
{
     ...
     *    http://example.com/
     */
    // base url untuk di jalankan menggunakan spark server
    public string $baseURL = 'http://localhost:8080/';
    // jika mau di jalankan di server lokal maka base urlnya di rubah seperti ini,
    // public string $baseURL = 'http://localhost/belajar-codeigniter4/public';
